...
public final class NVActivityIndicatorView: UIView {
    ...
    //MARK:- Set Loader Types ::MG
    //use loader from here
    //https://github.com/ninjaprox/NVActivityIndicatorView/tree/master/Sources/Base/Animations
    private final func setUpAnimation() {
        let animation: NVActivityIndicatorAnimationDelegate = NVActivityIndicatorAnimationCircleStrokeSpin() //::MG  USE here class
